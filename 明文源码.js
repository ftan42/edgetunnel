...
let addresses = [];
let addressesapi = [https://raw.githubusercontent.com/ftan42/cfipcaiji/refs/heads/main/ip.txt];
let addresses Notls = [];
let addresses notlsapi = [];
let addressescsv = [];
let DLS = 8;
let remarkIndex = 1;//CSV note column offset
